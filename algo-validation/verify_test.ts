import { ASSESSMENT_QUESTIONS, TIE_BREAKER_QUESTION, getNextQuestions, scoreAssessment, ROLE_DEFINITIONS, ROLE_ORDER } from '../src/lib/assessment-engine';
const pf1 = { r1:'r1_a',r2:'r2_a',r3:'r3_a',r4:'r4_a',r5:'r5_a' };
const pfFull = { ...pf1, b1:'pf_b1_a',b2:'pf_b2_a',b3:'pf_b3_a',b4:'pf_b4_a',rf:'rf_customer-support' };
const deskFull = { r1:'r1_c',r2:'r2_b',r3:'r3_b',r4:'r4_b',r5:'r5_b', b1:'do_b1_a',b2:'do_b2_a',b3:'do_b3_a',b4:'do_b4_a',rf:'rf_data-entry-mis' };
...
ok('allScores has all active roles', Object.keys(r1.allScores).length===ROLE_ORDER.length);
...
ok('empty responses rejected', (()=>{try{scoreAssessment({},{},'en');return false;}catch{return true;}})());
...
ok('ROLE_DEFINITIONS 6-dim vectors', Object.values(ROLE_DEFINITIONS).every(r=>r.vector.length===6));
